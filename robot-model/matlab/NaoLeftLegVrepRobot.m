classdef NaoLeftLegVrepRobot < DQ_SerialVrepRobot
    methods
        function obj = NaoLeftLegVrepRobot(robot_name, vrep_interface)
            % This method constructs an instance of a NaoLeftLegVrepRobot.
            % Usage:
            %     NaoLeftLegVrepRobot(robot_name, vrep_interface)
            ...
            %      vrep_robot = NaoLeftLegVrepRobot('NAO', vi);
            %     
            ...
            joints_names = LeftLeg.get_joints_names;
            obj.joint_names = {};
