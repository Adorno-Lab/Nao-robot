classdef BottomCamera
    methods (Static)
        function ret = kinematics()
            % Parameters
            neck_offset_z = 0.1265;
            bottom_camera_x = 0.05071;
            bottom_camera_z = 0.01774;
            bottom_camera_wy = 0.6929;
            ...
            txz = 1 + DQ.E * (1/2) * DQ([bottom_camera_x, 0, bottom_camera_z]);
            ry = cos(bottom_camera_wy/2) + DQ.j * sin(bottom_camera_wy/2);
