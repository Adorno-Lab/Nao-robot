classdef NaoRightLegVrepRobot < DQ_SerialVrepRobot
    methods
        function obj = NaoRightLegVrepRobot(robot_name, vrep_interface)
            % This method constructs an instance of a NaoRightLegVrepRobot.
            % Usage:
            %     NaoRightLegVrepRobot(robot_name, vrep_interface)
            ...
            %      vrep_robot = NaoRightLegVrepRobot('NAO', vi);
            %     
            ...
            joints_names = RightLeg.get_joints_names;
            obj.joint_names = {};
