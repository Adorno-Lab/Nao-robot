classdef NaoTopCameraVrepRobot < DQ_SerialVrepRobot
    methods
        function obj = NaoTopCameraVrepRobot(robot_name, vrep_interface)
            % This method constructs an instance of a NaoTopCameraVrepRobot.
            % Usage:
            %     NaoTopCameraVrepRobot(robot_name, vrep_interface)
            ...
            %      vrep_robot = NaoTopCameraVrepRobot('NAO', vi);
            %     
            ...
            joints_names = TopCamera.get_joints_names;
            obj.joint_names = {};
