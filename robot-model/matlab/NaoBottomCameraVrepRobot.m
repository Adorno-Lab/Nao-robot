classdef NaoBottomCameraVrepRobot < DQ_SerialVrepRobot
    methods
        function obj = NaoBottomCameraVrepRobot(robot_name, vrep_interface)
            % This method constructs an instance of a NaoBottomCameraVrepRobot.
            % Usage:
            %     NaoBottomCameraVrepRobot(robot_name, vrep_interface)
            ...
            %      vrep_robot = NaoBottomCameraVrepRobot('NAO', vi);
            %     
            ...
            joints_names = BottomCamera.get_joints_names;
            obj.joint_names = {};
