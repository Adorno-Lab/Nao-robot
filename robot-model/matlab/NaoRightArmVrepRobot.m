classdef NaoRightArmVrepRobot < DQ_SerialVrepRobot
    methods
        function obj = NaoRightArmVrepRobot(robot_name, vrep_interface)
            % This method constructs an instance of a NaoRightArmVrepRobot.
            % Usage:
            %     NaoRightArmVrepRobot(robot_name, vrep_interface)
            ...
            %      vrep_robot = NaoRightArmVrepRobot('NAO', vi);
            %     
            ...
            joints_names = RightArm.get_joints_names;
            obj.joint_names = {};
