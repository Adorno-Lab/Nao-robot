...
def main():
    try:
        ...
        for arm in arms:
            ...
            initial_pose = motion_proxy.getPosition(arm, motion.FRAME_ROBOT,
                                                    False)
            ...
            # To set the target position of the arm, the parameters are the x,
            # y, and z axis coordinates in meters relative to the FRAME_ROBOT.
            # The method wbSetEffectorControl is non blocking, so we use
            # time.sleep to allow the arm to arrive at the target position.
            # The recommended minimum period between two successive commands is
            # 0.2 seconds.
        ...
        # sets its motors off. For NAO H25, if the robot is standing, it goes
        # to the Crouch posture and it sets the Stiffness off. It is a
        # blocking call.
        motion_proxy.rest()
