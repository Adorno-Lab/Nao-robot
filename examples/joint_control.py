...
def main():
    try:
        ...
        # receives absolute or relative angles and relative times as parameters.
        # If there is a commandline choice of method to be used, it overwrites
        # the default.
        ...
        if args.method == 2:
            ...
            for arm in arms:
                ...
                # multiple target angles in one single method call, so we use a
                # FOR loop, but since it is a blocking call we do not need
                # time.sleep().
