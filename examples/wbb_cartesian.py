...
# This is a script with an example of cartesian control of the robot's arms and
# head using the Whole Body Balancer, a tool to generate safe and natural
# motion.
#
# Check the tutorial "Making NAO move" on
...
def main():
    ...
    for arm in arms:
        ...
        # allow the arm to arrive at the target position. The recommended
        # minimum period between two successive commands is 0.2 seconds.
